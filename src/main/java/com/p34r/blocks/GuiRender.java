...
public class GuiRender {
    ...
    public GuiRender(Window window) {
        ...
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("/shaders/gui.vs", GL_VERTEX_SHADER));
        shaderModuleDataList.add(new ShaderProgram.ShaderModuleData("/shaders/gui.fs", GL_FRAGMENT_SHADER));
    ...
    public void render(Scene scene) {
        ...
        scale.x = 3.0f / io.getDisplaySizeX();
        scale.y = -3.0f / io.getDisplaySizeY();
